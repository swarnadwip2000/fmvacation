                        ...
                        <tr>
                            <td align="center" valign="top">
                                <table class="" width="900"  align="center" cellpadding="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="450"><img src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('email_images/back-part--voucher.jpg')))}}" alt="" width="100%"/></td>
                                            <td width="350">
                                                        ...
                                                        <tr>
                                                            <td align="center" style="line-height: 0px;">
                                                                <img style="display:block; line-height:0px; font-size:0px; border:0px;"
                                                                    src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('email_images/logo.png')))}}"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="line-height: 0px;">
                                                                <img style="display:block; line-height:0px; font-size:0px; border:0px; width: 100px; height: 100px;"
                                                                    src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('email_images/qr.jpg')))}}"
